...
class NearByScreen2 extends ConsumerStatefulWidget {
  NearByScreen2({Key? key}) : super(key: key);
  _NearByScreenState2 createState() => _NearByScreenState2();
}

class _NearByScreenState2 extends ConsumerState<NearByScreen2> {
